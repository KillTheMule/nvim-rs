// Auto generated 2019-12-25 22:52:21.794183
      ...
      W: AsyncWrite + Send + Sync + Unpin + 'static,
{
      ...
      // TODO: This will clone always, make it a ref
        self.requester().ui_try_resize_grid(grid, width, height).await
    }
      ...
      // TODO: This will clone always, make it a ref
        ...
        pub async fn feedkeys(&self, keys: &str, mode: &str, escape_csi: bool) -> Result<(), Box<CallError>> {
      // TODO: This will clone always, make it a ref
      ...
      // TODO: This will clone always, make it a ref
        self.requester().input_mouse(button, action, modifier, grid, row, col).await
    }

        pub async fn replace_termcodes(&self, str: &str, from_part: bool, do_lt: bool, special: bool) -> Result<String, Box<CallError>> {
      // TODO: This will clone always, make it a ref
        self.requester().replace_termcodes(str, from_part, do_lt, special).await
    }
      ...
      // TODO: This will clone always, make it a ref
        self.requester().set_client_info(name, version, typ, methods, attributes).await
    }
      ...
      // TODO: This will clone always, make it a ref
        self.requester().parse_expression(expr, flags, highlight).await
    }
      ...
      // TODO: This will clone always, make it a ref
        self.requester().select_popupmenu_item(item, insert, finish, opts).await
    }
